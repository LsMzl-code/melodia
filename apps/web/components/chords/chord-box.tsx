...
const ChordBox: React.FC<ChordBoxProps> = ({ name, family, tonality }) => {
  //*** STATES ***//
  ...
  return (
    <div className='flex flex-col gap-1'>
      <div className='w-full rounded-md bg-[#313131] py-1.5 pr-1.5 flex items-center justify-start'>
        ...
        <div className='rounded-md bg-background p-1.5 flex flex-col gap-2 w-full'>
          ...
          <div className='flex items-center justify-between gap-2'>
            ...
            <div className='flex items-center gap-1'>
              ...
              {/* Scale page */}
              <IconButton icon={<Eye className="h-5 w-5" />} href={`/gammes/${tonality}`} title='Voir les gammes' className='hover:bg-cyan-500' />
            </div>
          </div>
          {/* Bottom */}
          {/* Notes */}
